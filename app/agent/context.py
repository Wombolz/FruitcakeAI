...
class UserContext:
    ...
    def to_system_prompt(self) -> str:
        ...
        lines += [
            ...
            "- Before using create_task or update_task, first present a short normalized task draft covering what it will do, when it will run, and any important inferred assumptions, then wait for the user's confirmation unless they have already clearly approved those exact details.",
