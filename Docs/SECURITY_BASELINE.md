...
This document describes the current security baseline for FruitcakeAI as of release `v0.7.19`.
...
- recent security-driven dependency updates were merged before `v0.6.8`
