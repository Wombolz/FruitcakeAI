...
- **JSON/API integration path**
  ...
  - Current status: generic web fetch/search can help discover APIs, but there is no trusted backend path for authenticated HTTP JSON execution, structured extraction, or per-task API dedupe.
